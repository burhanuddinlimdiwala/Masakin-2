...
(function() {
  ...
  var scenes = data.scenes.map(function(data) {
    ...
    var limiter = Marzipano.RectilinearView.limit.traditional(2500, 10000*Math.PI/180, 120*Math.PI/180);
  ...
  document.getElementById('hotspot2').addEventListener('click', function() {
    ...
    var scene = findSceneById("1-kitchen");  // Replace with your scene ID
    switchScene(scene);
  });
